...
c.ServerApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$5kwhAgIacZ/68DvVNSFDwg$ld46e1e9MglKdWgzVCtO8g'
...
#  Choices: any of ['sha224', 'sha512', 'blake2b', 'sha384', 'sha3_256', 'sha3_384', 'blake2s', 'md5', 'sha3_224', 'sha256', 'sha1', 'sha3_512']
#  Default: 'sha256'
